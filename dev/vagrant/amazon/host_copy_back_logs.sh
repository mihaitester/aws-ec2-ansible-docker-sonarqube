...
vagrant ssh -c "sudo cp /home/vagrant/yum.list.installed.txt /vagrant/data/yum.list.installed.txt"
...
vagrant ssh -c "sudo cp /home/vagrant/amazon-linux-extras.txt /vagrant/data/amazon-linux-extras.txt"
